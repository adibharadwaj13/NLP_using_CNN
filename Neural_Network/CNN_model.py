...
import numpy as np  
from Params import createParamsFile,loadfeatureParams,DumpfeatureParams
...
class TextCNN(object):
    ...
    def __init__(self, sequence_length,num_classes, vocab_size, 
                embedding_size, filter_sizes,num_filters,l2_reg=0.0):
        ...
        for i,filter_size in enumerate(filter_sizes):
            with tf.name_scope("conv-maxpool-%s" % filter_size):
                ...
                conv = tf.nn.conv2d(self.embedded_words_expanded,W,strides = [1,1,1,1],
